        ...
        <div className="overflow-y-auto px-5 py-4 space-y-5 text-sm leading-relaxed text-zinc-200">
          ...
          <section>
            ...
            <ul className="space-y-1.5 list-disc pl-5">
              ...
              <li><b>Next feed</b> — the index, expected time, suggested amount, and at the bottom: drift vs. the rigid grid (e.g. "running 22 min late") and a day-fit projection ("last #8 ~23:30 · fits the day", or "tight", or "won't fit — consider one extra or shorter intervals"). Time shifts with reality: if a feed runs late, the next slot slides over too. The amount auto-adjusts: behind = bump up to catch up, ahead = ease off.</li>
